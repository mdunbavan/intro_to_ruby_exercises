# 1. Create a directory called "lib" under your exercise files
# directory. In the /lib directory, declare a class named Person, with
# first_name and last_name attribute accessors. Declare an initialize
...
# your full name to the command line using the full_name
# method. Remember, Ruby must know how to find your class, and you
# must require it for your code below.
